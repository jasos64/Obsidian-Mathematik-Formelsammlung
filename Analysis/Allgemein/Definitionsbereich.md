Ein Definitionsbereich begrenzt Werte, die eine unter Bedingung gestellte [Variable(n)](Variable(n).md) annehmen können. Diese werden dann mittels eine Einordnung in [[Zahlensets]] beschrieben. Als Beispiel:
$$f(x)=\frac{1}{x}$$
